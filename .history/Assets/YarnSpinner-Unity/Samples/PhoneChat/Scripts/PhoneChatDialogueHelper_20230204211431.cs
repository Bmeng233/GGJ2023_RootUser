...
namespace Yarn.Unity.Example
{
    ...
    public class PhoneChatDialogueHelper : DialogueViewBase
    {
        ...
        public void CloneMessageBoxToHistory(Text optionText)
        {
            ...
            if (isFirstMessage == false)
            {
                ...
                {
                    GameObject optionBubblePrefab = dialogueBubblePrefab;
                    optionBubblePrefab.GetComponentInChildren<TMPro.TextMeshProUGUI>().text = optionText.text;
                    var oldClone = Instantiate(
                        optionBubblePrefab,
                        dialogueBubblePrefab.transform.position,
                        dialogueBubblePrefab.transform.rotation,
        ...
        //     {
        //         yield return StartCoroutine(Effects.Typewriter(lineText, lettersPerSecond, null));
